...
// to run test: sail artisan test --filter LibChatLanguageSpanishTest
class LibChatLanguageSpanishTest extends TestCase
{
    /**
    ...
    // Caminhos para os arquivos de array em diferentes diretórios
	{
        ...
        $path = base_path() . '/vendor/codificar/chat/src/resources/lang';
